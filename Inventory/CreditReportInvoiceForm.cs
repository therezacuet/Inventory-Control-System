...
namespace Inventory
{
    public partial class CreditReportInvoiceForm : Form
    {
        string fromDate = "";
        ...
        public CreditReportInvoiceForm()
        {
            InitializeComponent();
            
        }

        private void CreditReportInvoiceForm_Load(object sender, EventArgs e)
        {
            //for (int i = 60; i > 0; i--)
            //{
                ...
                while (iRow <= reportGridView.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (bNewPage)
                        {
                            ...
                            e.Graphics.DrawString("Credit Report", new Font(reportLabel.Font, FontStyle.Bold),
